...
- **First line:** `Hey there 👋, Moks here. Real human, sending this from Lagos. Before launch, I'd love to know: what's the last book you finished, and what do you wish your current book-club setup did better? Hit reply, even one sentence helps.`
...
3. **`Pull up a chair`** — alternate for the final CTA if you want to test against #1.
4. **`Save my seat`** — reserve for SMS / WhatsApp campaigns where "list" feels too cold.
...
- *The book club app that makes you actually finish the book.* — built for BookTok
- *Reading is having a moment. Make it a room.*
- *A home for the book you're reading right now.*
- *Finally finish the book.* — best for a solo-reader A/B test
